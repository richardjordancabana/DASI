...
public class VocabularioGestionCitas {
    ...
    public static final String NombreTipoNoticacionHardware="Lookup"; // Añadido 8 de mayo de 2015
    public static final String NombreTipoNoticacionIncidencia="Incidencia";
}
