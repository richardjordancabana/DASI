...
/* El extractor semántica identifica que la frase es una duda. */
if(anotType.equalsIgnoreCase("Duda")){ 
                 anotacionesInterpretadas.add(interpretarAnotacionDuda(contextoInterpretacion, annot));
//                 i++;
             }

/* El extractor semántica identifica que la frase contiene el nombre de una aplicación. */
...
/* El extractor semántica identifica que la frase contiene una negación. */
