...
public class InterpreteMsgsIRC {
     ...
     */
    // Se envia la informaciÃ³n al extrator semantico se traducen las anotaciones y se envia el contenido al agente de dialogo
    // de esta forma el agente recibe mensajes con entidades del modelo de informaciÃ³n
...
//                    mensajeAenviar.setColeccionContenido(infoExtraida); // los elementos de la colecciÃ³n se meterÃ¡n en el motor
                }
